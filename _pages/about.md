...
{% include figure.liquid loading="eager" path="assets/img/course_images/img_3_logos.jpg" class="img-fluid rounded z-depth-1" %}

### Learning Outcomes

We expect students to gain understanding, fluency in reasoning, and hands-on implementation skills of the following core systems concepts in mixed reality field :
...
{% include figure.liquid loading="eager" path="assets/img/course_images/img_6_plan_1.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/course_images/img_6_plan_2.jpg" class="img-fluid rounded z-depth-1" %}


### Slides from Lectures and Recitations

Will be placed in the course area at: "LINK HERE" soon after each lecture and recitation.
